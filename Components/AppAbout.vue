  ...
  <v-row class="pb-9 pb-md-12 pt-md-10 ma-0" justify="center" align="center">
    <v-col md="5" class="ga-3 d-flex flex-column px-0 px-md-6 pt-3 py-md-0">
      ...
      <v-col flat class="pa-0 pa-md-2">
        <v-row class="justify-space-between flex-column flex-md-row ma-0">
          <v-col class="pa-0" order="1" order-md="0">
            <v-card-title
              class="text-h6 text-lg-h5 custom-letter-spacing font-weight-bold pt-1 pb-1 pa-md-2 pt-md-5"
            >
              {{ aboutData.geo[0] }}
            </v-card-title>

            <v-card-text class="pa-md-2 py-md-0">
              <div class="text-body-2 text-lg-body-1 text-bgGreen w-75 w-md-100 custom-line-height">
                {{ aboutData.geo[1] }}
              </div>
            </v-card-text>
          </v-col>
